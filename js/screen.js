...
dom.WndOut.val = window.outerWidth+" x "+window.outerHeight+" ("+window.screenX+","+window.screenY+")";
dom.WndIn.val = window.innerWidth+" x "+window.innerHeight+" ("+window.mozInnerScreenX+","+window.mozInnerScreenY+")";
dom.PixDepth.val = screen.pixelDepth;
dom.ColDepth.val = screen.colorDepth;
dom.IsFS.val = window.fullScreen;
dom.ScrOrient.val = (function () {
...
dom.mmOrient.val = (function () {
	if (window.matchMedia("(orientation: portrait)").matches) return "portrait";
	if (window.matchMedia("(orientation: landscape)").matches) return "landscape";
})();
dom.mathOrient.val = (function () {
...
dom.DevPR.val = window.devicePixelRatio;

// PB Mode
try {
  var db = indexedDB.open("IsPBMode");
  db.onerror = function() {dom.IsPBMode.val = "true";};
  db.onsuccess = function() {dom.IsPBMode.val = "false";};
}
catch(err) {
  dom.IsPBMode.val = "unknown";
}

dom.Viewport.val = (function () {
